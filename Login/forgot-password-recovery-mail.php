...
$emailBody = "<div>" . $user["prenom"] . ",<br><br><p>Click this to recover your password : <br><a href='" . "http://167.114.152.54/~Aleaupro2020/Login/reset_password.php?email=" . $user["email"] . "&token=" . $token ."'>" . "
Change Password"."</a><br><br></p>Regards,<br> Admin.</div>";
