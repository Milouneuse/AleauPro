...
//LE PROJECT HOME EST DANS LA DOSSIER MAIL_CONFIGURATION.PHP
class SMTP
{
    /**
...
//$emailBody = "<div>" . $user["prenom"] . ",<br><br><p>Click this link to recover your password<br><a href='" . PROJECT_HOME . "reset_password.php?name=" . $user["prenom"] . "'>" . PROJECT_HOME . "reset_password.php?name=" . $user["prenom"] . "</a><br><br></p>Regards,<br> Admin.</div>";
	//Génère un token aléatoire


$emailBody = "<div>" . $user["prenom"] . ",<br><br><p>Click this to confirm the email change : <br><a href='" . "http://167.114.152.54/~Aleaupro2020/Login/changeEmailConfirmation.php?email=" . $user["email"] . "&token=" . $user["token"] . "&confirmation=yes" . "'>" . "Confirm The Email Change" ."</a><br><br>
<p>If you have no clue about anything regarding this message, please click this : <br><a href='" . "http://167.114.152.54/~Aleaupro2020/Login/changeEmailConfirmation.php?email=" . $user["email"] . "&token=" . $user["token"] . "&confirmation=no" . "'>" . "Cancel This" ."</a><br><br>
...
$mail->ReturnPath='aleaupro@gmail.com';	
